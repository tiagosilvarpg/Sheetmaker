...
public class RollDice extends javax.swing.JDialog  {
    ...
    private void initComponents() {
        ...
        faces = new javax.swing.JTextField();
        ...
        nomeLabel.setText("resultado");

        quantidade.setText("1");
        quantidade.setToolTipText("");

        faces.setText("6");
        faces.setToolTipText("");

        valorLabel.setText("quantidade");

        jLabel1.setText("faces");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(valorLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(quantidade, javax.swing.GroupLayout.PREFERRED_SIZE, 58, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(33, 33, 33)
                        .addComponent(jLabel1)
                        .addGap(16, 16, 16)
                        .addComponent(faces, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel3Layout.createSequentialGroup()
    ...
    private void okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okActionPerformed
        // OK
        int diceNumber,faceNumber,total=0,temp;
        String result="";
        diceNumber=Integer.parseInt(quantidade.getText().trim());
        faceNumber=Integer.parseInt(faces.getText().trim());
        if (diceNumber<1)diceNumber=1;
        if (faceNumber<2)faceNumber=2;
        
        do
        {
            temp=(1+(new Random()).nextInt(faceNumber));
            total+=temp;
            result+=temp+", ";
            diceNumber-=1;
        }while (diceNumber>0);
        
        resultado.setText(result+"total="+total);
    ...
    private javax.swing.JTextField faces;
