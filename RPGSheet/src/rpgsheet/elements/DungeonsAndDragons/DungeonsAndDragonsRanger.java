 ...
 * @author Tiago
 */
public class DungeonsAndDragonsRanger extends FichaDungeonsAndDragons{
  public DungeonsAndDragonsRanger(String creator,String sistema,Data data){
      super(creator,sistema,data);
  }
   public DungeonsAndDragonsRanger(DungeonsAndDragonsRanger b){
